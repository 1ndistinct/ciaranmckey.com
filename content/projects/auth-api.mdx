...
published: true
repository: https://github.com/thewatergategroups/authapi/tree/dev
repositoryId: R_kgDONbPPaA
repositoryName: ciaranmckey/ch-comments
---
...
This was built with React and TypeScript, using Mantine components. The UI code can be found [here](https://github.com/thewatergategroups/adminui)
